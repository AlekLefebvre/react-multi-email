...
var CustomizeStyle = /** @class */ (function (_super) {
    ...
    CustomizeStyle.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null, React.createElement("h3", null, "Email"), React.createElement(react_multi_email_1.ReactMultiEmail, { placeholder: React.createElement(React.Fragment, null, React.createElement("b", null, "I"), " am ", React.createElement("u", { style: { color: '#a0f2ff' } }, "placeholder"), " !"), style: { minHeight: '100px' }, emails: emails, onChange: function (_emails) {
